...
export default function WhatsAppButton() {
  const phoneNumber = "5511959319476"; // RevCryl phone number with country code
  const message = "Olá! Gostaria de saber mais sobre os produtos da RevCryl Tintas & Texturas.";
  ...
  return (
    <button
      ...
      className="whatsapp-float bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 group"
