      ...
      <div className="container mx-auto px-4 py-12">
          ...
          <div className="lg:col-span-2">
            <div className="mb-6">
              ...
              <p className="text-gray-300 leading-relaxed mb-4">
                Há mais de 15 anos oferecendo as melhores soluções em tintas, texturas e revestimentos. 
                Qualidade e excelência para transformar seus projetos em realidade.
              </p>
              <div className="flex space-x-4">
                ...
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987c6.62 0 11.987-5.367 11.987-11.987C24.014 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.73-3.016-1.801L7.2 14.374c.347.664.991 1.118 1.742 1.118c1.078 0 1.953-.875 1.953-1.953S9.02 11.586 7.942 11.586c-.751 0-1.395.454-1.742 1.118L4.433 11.89c.568-1.071 1.719-1.801 3.016-1.801c1.894 0 3.428 1.534 3.428 3.428S10.343 16.945 8.449 16.945z"/>
                  </svg>
                </a>
                <a 
                  href="https://wa.me/5511959319476" 
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center text-gray-300">
                ...
                <a href="tel:+551159319476" className="hover:text-green-400 transition-colors">
                  (11) 5931-9476
                </a>
              </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-400 text-sm mb-4 md:mb-0">
            © 2024 RevCryl Tintas & Texturas. Todos os direitos reservados.
          </div>
